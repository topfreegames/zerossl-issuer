...
import (
	...
	"github.com/topfreegames/zerossl-issuer/test/utils"
)

// namespace where the project is deployed in
const namespace = "zerossl-issuer-system"

// serviceAccountName created for the project
const serviceAccountName = "zerossl-issuer-controller-manager"

// metricsServiceName is the name of the metrics service of the project
const metricsServiceName = "zerossl-issuer-controller-manager-metrics-service"

// metricsRoleBindingName is the name of the RBAC that will be created to allow get the metrics data
const metricsRoleBindingName = "zerossl-issuer-metrics-binding"
